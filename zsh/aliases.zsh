...
alias update='sudo softwareupdate -i -a; brew update && brew upgrade brew-cask; brew upgrade; brew prune; brew cleanup; npm update npm -g; npm update -g; sudo gem update; cd ~/.rbenv/ && git pull —rebase; cd ~/.rbenv/plugins/ruby-build/ && git pull —rebase; cd'
